...
public class MessageConstant {
    ...
    public static final String QUERY_CHECKGROUPCHECKITEM_SUCCESS = "查询检查组的检查项成功";
    public static final String QUERY_CHECKGROUPCHECKITEM_FAIL = "查询检查组的检查项失败";
    public static final String QUERY_MEMBER_FAIL = "查询会员档案失败";
    public static final String QUERY_MEMBER_SUCCESS = "查询会员档案成功";
    public static final String QUERY_ROLE_FAIL = "查询角色列表失败";
    ...
    public static final String DELETE_USER_FAIL = "删除会员失败";
    public static final String DELETE_USER_SUCCESS = "删除会员成功";
    ...
    public static final String GET_ROLE_FAIL = "获取角色失败";
